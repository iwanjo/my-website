      ...
      <section className={styles.challenge} id="section2">
        <div className={styles.challengeDiv}>
          ...
          <p className={styles.problemText}>
            ...
            fertilisers in plantations, limited public and private investment in
            infrastructure, and lack of well-trained agri-experts to improve on
            farming methods. If sustainable solutions are not implemented to
            reduce harvest loss, enable better access to markets and reduce
            degradation in farmlands, poverty and food hunger will continue
            rising rise, leading to a failure in SDG 2.
          </p>
        </div>
